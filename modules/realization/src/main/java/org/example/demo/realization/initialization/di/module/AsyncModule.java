...
import org.example.demo.core.adapter.ui.RootAdapter;
import org.example.demo.core.controller.ui.ControllerAdapter;
...
import org.example.demo.realization.level.async.BackgroundExecutor;
import org.example.demo.realization.level.async.clipboard.ClipboardProcessorAsyncWrapper;
import org.example.demo.realization.level.async.logic.EventProcessorAsyncWrapper;
...
import org.example.demo.realization.level.async.ui.RootAdapterAsyncWrapper;
import org.example.demo.realization.level.transport.Channel;
import org.example.demo.realization.level.transport.ChannelMock;
import org.example.demo.realization.level.transport.clipboard.ClipboardEventReceiverWrapper;
import org.example.demo.realization.level.transport.clipboard.ClipboardEventSenderWrapper;
import org.example.demo.realization.level.transport.logic.LogicEventReceiverWrapper;
import org.example.demo.realization.level.transport.logic.LogicEventSenderWrapper;
