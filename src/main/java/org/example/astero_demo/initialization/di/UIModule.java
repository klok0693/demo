...
public class UIModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(RootShortcutHandler.class).toProvider(ShortcutProvider.class).in(Scopes.SINGLETON);
        ...
        bind(RootAdapter.class).toProvider(RootAdapterProvider.class).in(Scopes.SINGLETON);
    }
}
